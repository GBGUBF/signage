(function () {
  ...
  if (params.size > 0) {
    ...
    inputs = JSON.parse(Object.fromEntries(Array.from(params.entries()))).signageConfiguration.items;
    setupDisplay(inputs);
  }
  ...
  document.addEventListener("DOMContentLoaded", async event => {
    ...
    setInterval(function () {
      Array.prototype.slice.call(document.getElementsByTagName("iframe")).forEach(iframe => {
        iframe.src = iframe.src;
      });
    }, 600000);
  });
